...
class ObjectsOnRoad(object):
    """
    This class 1) detects what objects (namely stop sign and legos) are on the road
    ...
    def __init__(self,
                 car=None,
                 speed_limit=20,
                 model='/home/pi/picar-4wd/models/detect.tflite',
                 label='/home/pi/picar-4wd/models/labelmap.txt',
                 width=640,
                 height=480):
        # model: This MUST be a tflite model that was specifically compiled for Edge TPU.
        # https://coral.withgoogle.com/web-compiler/
        logging.info('Creating a ObjectsOnRoad...')
        self.width = width
        self.height = height
      ...
      #  self.speed = speed_limit
        ...
        #
        self.traffic_objects = {0: Bat(),
                                1: Ninja(),
                                2: StopSign(),
                                3: TrafficLight(),
                                4: StopSign(),#Empty space later
                                5: StopSign()#Path later
                                }
...
############################
def test_photo(file):
    object_processor = ObjectsOnRoad()
...
def test_stop_sign():
    ...
    object_processor = ObjectsOnRoad()
    frame = cv2.imread('/home/pi/picar-4wd/images/stopsign1.jpg')
    combo_image = object_processor.process_objects_on_road(frame)
    show_image('Stop 1', combo_image)
    time.sleep(1)
    frame = cv2.imread('/home/pi/picar-4wd/images/stopsign2.jpg')
    combo_image = object_processor.process_objects_on_road(frame)
    show_image('Stop 2', combo_image)
    time.sleep(2)
    frame = cv2.imread('/home/pi/picar-4wd/images/stopsign3.jpg')
    combo_image = object_processor.process_objects_on_road(frame)
    show_image('Stop 3', combo_image)
    time.sleep(1)
    frame = cv2.imread('/home/pi/picar-4wd/images/bat1.jpg')
    combo_image = object_processor.process_objects_on_road(frame)
...
if __name__ == '__main__':
    ...
    # These processors contains no state
        test_photo('/home/pi/picar-4wd/images/stopsign1.jpg')
        test_photo('/home/pi/picar-4wd/images/bat1.jpg')
        test_photo('/home/pi/picar-4wd/images/ninja1.jpg')
        test_photo('/home/pi/picar-4wd/images/mix1.jpg')
        test_photo('/home/pi/picar-4wd/images/stopsign2.jpg')
        test_photo('/home/pi/picar-4wd/images/trafficlight1.jpg')
